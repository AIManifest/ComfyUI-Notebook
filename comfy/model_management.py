...
listen = data["listen"]
port = data["port"]
enable_cors_header = data["enable_cors_header"]
max_upload_size = data["max_upload_size"]

extra_model_paths_config = data["extra_model_paths_config"]
...
dont_upcast_attention = data["dont_upcast_attention"]

force_fp32 = data["force_fp32"]
force_fp16 = data["force_fp16"]

bf16_unet = data["bf16_unet"]
fp16_unet = data["fp16_unet"]
fp8_e4m3fn_unet = data["fp8_e4m3fn_unet"]
fp8_e5m2_unet = data["fp8_e5m2_unet"]
fp16_vae = data["fp16_vae"]
fp32_vae = data["fp32_vae"]
bf16_vae = data["bf16_vae"]

cpu_vae = data["cpu_vae"]

fp8_e4m3fn_text_enc = data["fp8_e4m3fn_text_enc"]
fp8_e5m2_text_enc = data["fp8_e5m2_text_enc"]
fp16_text_enc = data["fp16_text_enc"]
fp32_text_enc = data["fp32_text_enc"]

directml = data["directml"]

disable_ipex_optimize = data["disable_ipex_optimize"]
...
novram = data["novram"]
cpu = data["cpu"]
disable_smart_memory = data["disable_smart_memory"]
deterministic = data["deterministic"]
dont_print_server = data["dont_print_server"]
quick_test_for_ci = data["quick_test_for_ci"]
windows_standalone_build = data["windows_standalone_build"]
disable_metadata = data["disable_metadata"]
multi_user = data["multi_user"]
